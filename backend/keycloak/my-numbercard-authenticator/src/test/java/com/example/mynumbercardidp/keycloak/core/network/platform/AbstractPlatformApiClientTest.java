...
public class AbstractPlatformApiClientTest {
    ...
    public void setup() {
        ...
        doReturn(authenticationRequest).when(requestAndResponseDataManager).getUserRequest();
        doReturn(authenticationRequest).when(requestAndResponseDataManager).getPlatformRequest();
        doReturn(platformAuthenticationResponseStructure).when(requestAndResponseDataManager).getPlatformResponse();
