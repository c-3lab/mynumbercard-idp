...
public class PlatformApiClientResolverTest {
    PlatformApiClientResolver platformApiClientResolver = new PlatformApiClientResolver();
    @Mock
    ...
    public void testCreatePlatform() {
        assertDoesNotThrow(() -> {
            platformApiClientResolver.createPlatform("com.example.mynumbercardidp.keycloak.network.platform.PlatformApiClient", context, "/verify");
        });
    }

    @Test
    public void testCreatePlatformWithoutClass() {
        assertThrows(Exception.class, () -> {
            platformApiClientResolver.createPlatform("", context, "/verify");
        });
    }
}
