...
public class ActionResolverTest {
    ...
    public void setUp() {
        ...
        doReturn(httpRequest).when(context).getHttpRequest();
        doReturn(decodedParams).when(httpRequest).getDecodedFormParameters();
        doReturn(authenticatorConfigModel).when(context).getAuthenticatorConfig();
        ...
        try(
            ...
            MockedConstruction<PlatformApiClient> platformApiClient = mockConstruction(PlatformApiClient.class,
                                                        (mock, ctx) -> {
                                                            ...
                                                            doReturn(authenticationRequest).when(mock).getUserRequest();
                                                        });
        ) {
