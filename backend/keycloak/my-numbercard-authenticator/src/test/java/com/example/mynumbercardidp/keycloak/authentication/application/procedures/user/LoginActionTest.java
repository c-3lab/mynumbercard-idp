...
public class LoginActionTest {
  ...
  public void setUp() throws Exception {
    ...
    when(context.getSession().keys()).thenReturn(keyManager);
    when(context.getSession().keys().getActiveKey(realmModel, KeyUse.ENC, "RSA-OAEP-256")).thenReturn(keyWrapper);
  ...
  public void testAuthenticate(String applicantData, Boolean isCheckedStatusCode, Boolean existsUser) throws Exception {
    ...
    try(
      ...
      if (applicantData.equals("dummy")) {
        ...
        verify(context, times(3)).getSession();
