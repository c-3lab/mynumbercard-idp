...
public class MyNumberCardAuthenticatorTest {
    MyNumberCardAuthenticator myNumberCardAuthenticator = new MyNumberCardAuthenticator();
    ...
    public void setup() {
        ...
        refreshUrl = URI.create("https://8fee-118-238-7-69.ngrok-free.app/realms/OIdp/login-actions/authenticate?client_id=sample-client&tab_id=3tSMeWfeVcQ&auth_session_id=204abe79-3551-4fe2-9800-a645615a2bc0");
        ...
        Mockito.when(context.getAuthenticationSession().getAuthNote("nonce")).thenReturn("752bb712-055a-4091-b35e-45973c475dcc");
        ...
        Mockito.when(context.getHttpRequest().getDecodedFormParameters()).thenReturn(decodedParams);
